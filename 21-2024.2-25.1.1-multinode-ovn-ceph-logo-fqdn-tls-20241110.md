...
#     link/ether bc:24:11:60:4d:82 brd ff:ff:ff:ff:ff:ff
#     altname enp6s18
#     inet 192.168.0.61/24 brd 192.168.0.255 scope global eth0
#        valid_lft forever preferred_lft forever
#     inet6 fe80::be24:11ff:fe60:4d82/64 scope link
#        valid_lft forever preferred_lft forever
# 3: eth1: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc fq_codel state UP group default qlen 1000
#     link/ether bc:24:11:d2:6e:9e brd ff:ff:ff:ff:ff:ff
#     altname enp6s19
#     inet 192.168.30.0/24 brd 192.168.30.255 scope global eth1
#        valid_lft forever preferred_lft forever
#     inet6 fe80::be24:11ff:fed2:6e9e/64 scope link
...
```bash
ceph auth get-or-create client.kolla-glance mon 'profile rbd' osd 'profile rbd pool=images' mgr 'profile rbd pool=images'
# [client.kolla-glance]
#         key = AQAvtCFngjCvHBAAiG/25MZ7tQ5+7K8dlEv7pw==

ceph auth get-or-create client.kolla-cinder mon 'profile rbd' osd 'profile rbd pool=volumes, profile rbd pool=vms, profile rbd-read-only pool=images' mgr 'profile rbd pool=volumes, profile rbd pool=vms'
# [client.kolla-cinder]
#         key = AQA2tCFn6/NWOhAAMZtQB77qXTFVobCcCQ58SQ==

ceph auth get-or-create client.kolla-cinder-backup mon 'profile rbd' osd 'profile rbd pool=backups' mgr 'profile rbd pool=backups'
# [client.kolla-cinder-backup]
#         key = AQA3tCFnMfYwChAABLiZsvQiVwWrGgCh4r1J2w==
...
#   python version = 3.10.12 (main, Sep 11 2024, 15:47:36) [GCC 11.4.0] (/home/ubuntu/kolla/bin/python3)
#   jinja version = 3.1.4
#   libyaml = True
...
---
[all]
control01       ansible_host="192.168.0.62" network_interface="eth0" neutron_external_interface="eth1"
compute01       ansible_host="192.168.0.10" network_interface="ens1f1np1" neutron_external_interface="ens15f3"
compute02       ansible_host="192.168.0.11" network_interface="ens1f1np1" neutron_external_interface="ens15f3"
[control]
control01
[network]
control01
